...
public class UpdateCategory extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("views/admin/update_category.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        request.setAttribute("updated", "Loại Sản Phẩm Đã Được Chỉnh Sửa");
        request.getRequestDispatcher("list_category").forward(request, response);
    }
