    ...
    <div class="product-item bg-light mb-4">
        <div class="product-img position-relative overflow-hidden">
            ...
            <div class="product-action">
                <a class="btn btn-outline-dark" href="<c:url value='/user_product_details?id=${product.id}'/>"><i class="s-cart fa fa-shopping-cart"></i><span>Thêm Vào Giỏ Hàng</span></a>
            </div>
        </div>
        <div class="text-center py-4">
            <p class="d-flex justify-content-center align-items-center" style="white-space: break-spaces; word-break: break-word; min-height: 48px">${product.name}</p>
