...
<html lang="en">
    ...
    <body>
                ...
                <div class="row flex-column">
                    ...
                    <form action="user_update_profile" method="post" id="form" class="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="full-name" name="full_name" value="${user.fullname}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="phone-number" maxlength="11"
                        ...
                        <div class="form-group">
                            <button class="btn btn-primary form-control">Cập Nhật Thông Tin</button>
                        </div>
                    </form>
                </div>
        ...
        <script src="<c:url value="/template/user/update_profile/js/main.js"/>"></script>
