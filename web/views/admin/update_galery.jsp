            ...
            <div class="content-wrapper" style="min-height: 836px;">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<c:url value='/list_galery'/>">Quản lý hình ảnh sản phẩm</a></li>
                        <li class="active">Sửa hình ảnh sản phẩm</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row justify-content-center">
                        <div class="col-xl-6">
                            <form action="<c:url value='/update_galery'/>" method="post">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="product_id" id="product_id">
                                            <c:forEach var="product" items="${requestScope.products}">
                                                <option ${(requestScope.product_id == product.id)?'selected':''} value="${product.id}">${product.name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-4">Chọn ảnh:</div>
                                    <div class="col-sm-8 ">
                                        <div class="d-flex justify-content-between">
                                            <label for="fileInput" class="col-sm-6 col-form-label galery_thumbnail" title="Bấm để chọn file!">
                                                <input type="file" accept=".jpg, .png" class="form-control file-input" name="thumbnail" id="fileInput" value="${requestScope.thumbnail}">
                                                <span id="fileName">Chọn file</span>
                                            </label>
                                            <img src="<c:url value='/assets/images/${requestScope.thumbnail}'/>" alt="" class="thumbnail" id="imgInput">
                                        </div>
                                    </div>
                                </div>
                                <div>
