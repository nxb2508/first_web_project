            ...
            <div class="content-wrapper" style="min-height: 836px;">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<c:url value='/list_category'/>">Quản lý loại sản phẩm</a></li>
                ...
                <section class="content">
                    <div class="row justify-content-center">
                        <div class="col-xl-6">
                            <form action="<c:url value='/update_category'/>" method="post">
                                <div class="form-group row">
                                  <label for="categoryId" class="col-sm-4 col-form-label">Id</label>
                                  <div class="col-sm-8">
                                    <input type="text" readonly name="category_id" class="form-control-plaintext" id="categoryId" value="${requestScope.category_id}">
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="name" class="col-sm-4 col-form-label">Tên loại sản phẩm</label>
                                  <div class="col-sm-8">
                                    <input type="text" class="form-control" name="category_name" id="name" value="${requestScope.category_name}">
                                  </div>
                                </div>
