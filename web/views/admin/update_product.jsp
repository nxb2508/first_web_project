            ...
            <div class="content-wrapper" style="min-height: 836px;">
                ...
                <section class="content">
                    <div class="row justify-content-center">
                        <div class="col-xl-6">
                            <form action="<c:url value='/update_product'/>" method="post">
                                <div class="form-group row">
                                    <label for="id" class="col-sm-4 col-form-label">Id</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="id" id="id" value="${requestScope.id}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="category_id" id="category_id">
                                            <c:set var="category_id" value="${requestScope.category_id}"/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" name="description" id="description" cols="30" rows="10"><c:out value="${requestScope.description}"/></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="price" class="col-sm-4 col-form-label">Giá</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="price" id="price" value="${requestScope.price}">
                                    </div>
                                </div>
                                <div>
