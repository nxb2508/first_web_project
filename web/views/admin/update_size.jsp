            ...
            <div class="content-wrapper" style="min-height: 836px;">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<c:url value='/list_category'/>">Quản lý kích thước sản phẩm</a></li>
                        <li class="active">Sửa kích thước sản phẩm</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row justify-content-center">
                        <div class="col-xl-6">
                            <form action="<c:url value='/admin-update-size'/>" method="post">
                                <div class="form-group row">
                                  <label for="categoryId" class="col-sm-4 col-form-label">Id</label>
                                  <div class="col-sm-8">
                                    <input type="text" readonly name="size_id" class="form-control-plaintext" id="categoryId" value="${requestScope.size_id}">
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="name" class="col-sm-4 col-form-label">Tên loại sản phẩm</label>
                                  <div class="col-sm-8">
                                    <input type="text" class="form-control" name="size_name" id="name" value="${requestScope.size_name}">
                                  </div>
                                </div>
