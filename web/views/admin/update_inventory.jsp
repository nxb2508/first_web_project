            ...
            <div class="content-wrapper" style="min-height: 836px;">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Cập nhật số lượng sản phẩm trong kho</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row justify-content-center">
                        <div class="col-xl-8">
                            <form action="<c:url value='/admin-update-inventory'/>" class="update-inventory" id="form" method="post">
                                <c:set var="inventory" value="${requestScope.inventory}" />
                                <div class="form-group row">
                                    <label for="id" class="col-sm-4 col-form-label">Id:</label>
                                    <div class="col-sm-8 d-flex">
                                        <input type="text" id="id" name="id" value="${inventory.id}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="product_id" class="col-sm-4 col-form-label">Sản phẩm:</label>
                                    <div class="col-sm-8 d-flex flex-column" >
                                        <input type="text" id="product_id" value="${(inventory.product.name != null)?inventory.product.name:'Chưa chọn sản phẩm'}" readonly>
                                        <img src="<c:url value='/assets/images/${inventory.product.galeries[0].thumbnail}'/>" alt="" class="thumbnail" id="imgInput">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="size_id" class="col-sm-4 col-form-label">Kích thước:</label>
                                    <div class="col-sm-8 d-flex">
                                        <input type="text" id="size_id" value="${inventory.size.name}" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <button type="submit" class="btn btn-primary" id="gui">Cập nhật số lượng sản phẩm trong kho</button>
                            </form>
                        </div>
                    </div>
                </section>
