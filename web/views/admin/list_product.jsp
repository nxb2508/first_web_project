                ...
                <section class="content">
                    <div class="row justify-content-center justify-content-xl-center">
                        <div class="col-xl-8 d-flex content-top justify-content-between row">
                            ...
                            <form action="<c:url value='/search_product'/>" method="get" class="sidebar-form col-xl-9 search-product">
                                <div class="input-group">
                                    <input type="text" name="search_description" class="form-control" placeholder="Tìm kiếm sản phẩm">
                                </div>
                                <div class="row d-flex justify-content-start align-items-center ">
                                    ...
                                    <div class="input-group col-xl-2 d-flex justify-content-start align-items-center" >
                                        ...
                                        <input type="radio" name = "sort_by" id="radio_sort1" value="none" checked>
                                    </div>
                                    <div class="input-group col-xl-2 d-flex justify-content-start align-items-center" >
                                        <label class="search_option label" for="radio_sort2" >Tăng dần</label>
                                        <input type="radio" name = "sort_by" id="radio_sort2" value="asc">
                                    </div>
                                    <div class="input-group col-xl-2 d-flex justify-content-start align-items-center" >
                                        <label class="search_option label" for="radio_sort3" >Giảm dần</label>
                                        <input type="radio" name = "sort_by" id="radio_sort3" value="desc">
                                    </div>
                        ...
                        <div class="col-xl-12 d-flex justify-content-center">
                            <ul class="pagination">
                                ...
                                <c:forEach begin="${1}" end="${requestScope.totalPages}" var="i">
                                    <li class="page-item ${(i==page)?"active":""}"><a class="page-link" href="list_product?page=${i}">${i}</a></li>
                                </c:forEach>
                            </ul>
                        </div>
                    </div><!-- /.row -->
