            ...
            <div class="content-wrapper" style="min-height: 836px;">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<c:url value='/admin-list-size'/>">Quản lý kích thước sản phẩm</a></li>
                        <li class="active">Thêm kích thước sản phẩm</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row justify-content-center">
                        <div class="col-xl-6">
                            <form action="<c:url value='/admin-add-size'/>" method="post">
                                <div class="form-group row">
                                    <label for="name" class="col-sm-4 col-form-label">Tên kích thước sản phẩm</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="size_name" id="name">
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary" >Thêm kích thước sản phẩm</button>
                            </form>
                        </div>
                    </div>
                </section>
